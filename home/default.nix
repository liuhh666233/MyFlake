...

{
  ...
  programs.fish = {
    ...
    # set -U fish_user_paths /home/lxb/.cargo/bin /run/wrappers/bin /nix/var/nix/profiles/default/bin /Users/lhh/.cargo/bin /Users/lhh/.nix-profile/bin /run/current-system/sw/bin /usr/local/sbin /usr/local/bin /usr/bin /opt/homebrew/bin
    shellInit = ''
